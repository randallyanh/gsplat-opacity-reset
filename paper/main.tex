...
% ════════════════════════════════════════════════════════════════
\paragraph{Code and artifacts.} The reproduction entrypoint and JSON evidence are identified by relative paths in the experiments section. Code and artifacts: \url{https://github.com/randallyanh/gsplat-opacity-reset}.
